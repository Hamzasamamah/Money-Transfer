...
namespace Money_Transformer.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,PhoneNum,Message")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,PhoneNum,Message")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
